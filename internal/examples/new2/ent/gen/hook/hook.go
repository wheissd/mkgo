...
type HumanFunc func(context.Context, *gen.HumanMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f HumanFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.HumanMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.HumanMutation", m)
}
