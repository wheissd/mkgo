...
func ID(id uuid.UUID) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id uuid.UUID) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...uuid.UUID) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...uuid.UUID) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id uuid.UUID) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id uuid.UUID) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id uuid.UUID) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id uuid.UUID) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldLTE(FieldID, id))
}

// Name applies equality check predicate on the "name" field. It's identical to NameEQ.
func Name(v string) predicate.DefaultModel {
	return predicate.DefaultModel(sql.FieldEQ(FieldName, v))
}
